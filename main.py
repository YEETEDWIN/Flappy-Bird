...
ground_img = pygame.image.load('Flappy Bird/images/ground.png')
reset_img = pygame.image.load('Flappy Bird/images/restart.png')
...
score = 0
pass_pipe = False
font = pygame.font.SysFont("Apple Chancery", 60)
...
class Bird(pygame.sprite.Sprite):
  def __init__(self, x,y):
    ...
    for i in range(1,4):
      img = pygame.image.load(f'Flappy Bird/images/bird{i}.png')
...
class Pipe(pygame.sprite.Sprite):
  def __init__(self, x, y, position):
    ...
    self.rect = self.image.get_rect()
    # position 1 => pipe from top, position -1 => pipe from bottom
    if position == 1:
...
button = Button(screen_width//2 -50, screen_height//2 - 100, reset_img)
